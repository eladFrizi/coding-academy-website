            ...
            <div class="container">
                <div class="carousel-caption black text-right pr-1em">
                    ...
                    <div class="mtb-2em">
                        <h3>
                            המחזור הקרוב:
                            <span class="navy">01.09.2016</span>
                        </h3>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-sm-6 wow fadeInRight text-right ">
                ...
                <p>
                    מאז השירות בבסמ"ח (ממר"ם) כמדריך ובעשרים שנה שחלפו הכשרתי אלפי מפתחים בטכנולוגיות שונות,
                    ואני גאה לומר שהמסלול שלפניך הוא זיקוק של הניסיון שלי, והמעקב הרציף שלנו אחרי ההתפתחויות בעולם
                    הטכנולוגי.
                </p>
            </div>
...
בין הדברים שנלמד
        ...
        <div class="principles">
            <div class="row">
                <div class="col-sm-4 text-center plr-1em ">
                    <img src="img/tech/JavaScript-logo.png" alt="">
                    <h4>JavaScript</h4>
            ...
            <div class="row">
                <div class="col-sm-4 text-center plr-1em">
                    <img src="img/tech/angular.png" alt="">
                    <h4>AngularJS</h4>
                ...
                <div class="col-sm-4 text-center plr-1em">
                    <img src="img/tech/nodejs.png" alt="">
                    <h4>Node.js</h4>


                </div>
                <div class=" tech-desc col-sm-4 text-center plr-1em">
    ...
    <div class="container">
        ...
        <div class="col-sm-3 wow fadeInRight mtb-2em">
            <div class="team-member">
                ...
                <a class="phone-number" href="tel:054-3163124" dir="ltr"><span class="navy"><i
                        class="fa fa-phone small-icon"></i> 054-2468624</span></a>
            </div>
        </div>
        ...
        <div class="row m-b-lg plr-2em ">
            <form id="contactForm">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" id="message" placeholder="נשמח לשמוע ממך"></textarea>
                </div>
				
				<div class="form-group">
                    <label for="captcha">אנושי?</label></br>
                    <img src="<?php echo $_SESSION['captcha']['image_src'] ?>" />
                    <input type="text" class="form-control" id="captcha" placeholder="הקלד את התווים מהתמונה">
                </div>

				<!--Test GA -->
                <div class="col-lg-12 text-center">
                    <button type="submit" class="btn btn-primary" id="contactSubmit" onclick="ga('send', 'event', 'Buttons', 'Submit', 'Form');">
                        שלח
