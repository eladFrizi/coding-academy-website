        ...
        <div class="item active">
            <div class="container">
                <div class="carousel-caption black text-right pr-1em">
                    ...
                    <div class="mtb-2em important-info" style="margin-bottom: 0;">
...
בין הדברים שנלמד
        ...
        <div class="row">
            <div class=" text-center mtb-2em">
                <a target="_blank" href="https://www.coding-academy.org/pdf/syllabus.pdf" class="btn btn-primary ">להורדת הסילבוס
                    המלא</a>
            </div>
        </div>
    </div>
...
<section id="team" class=" team pb-3em">
    <div class="container">
        ...
        <div class="col-sm-4 mtb-2em wow fadeInRight">
            <div class="team-member">
                <img src="img/team/assaf-margailt.jpg" class="img-responsive img-circle team-member-image" alt="">
                <h4><span class="navy">אסף</span> מרגלית</h4>

                <p>סמנכ"ל פיתוח עסקי </p>
            </div>
        </div>
        <div class="col-sm-4 mtb-2em">
            <div class="team-member wow zoomIn">
                <img src="img/team/yaron.jpg" class="img-responsive img-circle team-member-image" alt="">
        ...
        <div class="col-sm-4 wow fadeInRight mtb-2em">
            <div class="team-member">
                <img src="img/team/roni.jpg" class="img-responsive img-circle team-member-image" alt="">
